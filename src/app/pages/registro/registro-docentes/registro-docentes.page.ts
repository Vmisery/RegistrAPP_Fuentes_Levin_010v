...
export class RegistroDocentesPage implements OnInit {
  ...
  constructor(private fb: FormBuilder, private http: HttpClient, private asignaturasService: AsignaturasService, private dataService: DataService) {
  ...
  registrarDocente() {
      if (this.docenteForm.valid) {
        ...
        this.http.post('http://localhost:3300/docentes', this.newDocente).subscribe((respuesta) => {
          console.log('Docente registrado con éxito', respuesta);
        }
